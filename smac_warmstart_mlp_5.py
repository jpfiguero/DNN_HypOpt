...
opt = pysmac.SMAC_optimizer( working_directory = './results/dataset5/smac_warm/' % os.environ, persistent_files=True, debug = False)

# Warmstart for Dataset #5 (optimum parameters from Dataset #8)
parameter_definition=dict(\
		number_layers = ("integer", [1,4], 2),
		number_neurons_1  =("integer", [10,1000], 433, 'log'),
		number_neurons_2  =("integer", [10,1000], 80, 'log'),
		number_neurons_3  =("integer", [10,1000], 149, 'log'),
		number_neurons_4  =("integer", [10,1000], 20, 'log'),
		dropout_rate =("real", [0,1],    0.08382525963704424),
		)
