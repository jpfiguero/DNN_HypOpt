...
opt = pysmac.SMAC_optimizer( working_directory = './results/dataset12/smac_warm/' % os.environ, persistent_files=True, debug = False)

# Warmstart for Dataset #12 (optimum parameters from Dataset #1)
parameter_definition=dict(\
		number_layers = ("integer", [1,4], 1),
		number_neurons_1  =("integer", [10,1000], 1000, 'log'),
		number_neurons_2  =("integer", [10,1000], 333, 'log'),
		number_neurons_3  =("integer", [10,1000], 34, 'log'),
		number_neurons_4  =("integer", [10,1000], 579, 'log'),
		dropout_rate =("real", [0,1],  0.008758259176848582),
		)
