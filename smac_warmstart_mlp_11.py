...
opt = pysmac.SMAC_optimizer( working_directory = './results/dataset11/smac_warm/' % os.environ, persistent_files=True, debug = False)

# Warmstart for Dataset #11 (optimum parameters from Dataset #5)
parameter_definition=dict(\
		number_layers = ("integer", [1,4], 2),
		number_neurons_1  =("integer", [10,1000], 677, 'log'),
		number_neurons_2  =("integer", [10,1000], 17, 'log'),
		number_neurons_3  =("integer", [10,1000], 771, 'log'),
		number_neurons_4  =("integer", [10,1000], 100, 'log'),
		dropout_rate =("real", [0,1],    0.04603083973182265),
		)
