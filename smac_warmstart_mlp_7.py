...
opt = pysmac.SMAC_optimizer( working_directory = './results/dataset7/smac_warm/' % os.environ, persistent_files=True, debug = False)

# Warmstart for Dataset #7 (optimum parameters from Dataset #5)
