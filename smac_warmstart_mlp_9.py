...
opt = pysmac.SMAC_optimizer( working_directory = './results/dataset9/smac_warm/' % os.environ, persistent_files=True, debug = False)

# Warmstart for Dataset #9 (optimum parameters from Dataset #4)
