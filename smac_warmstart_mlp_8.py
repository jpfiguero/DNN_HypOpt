...
opt = pysmac.SMAC_optimizer( working_directory = './results/dataset8/smac_warm/' % os.environ, persistent_files=True, debug = False)

# Warmstart for Dataset #8 (optimum parameters from Dataset #5)
