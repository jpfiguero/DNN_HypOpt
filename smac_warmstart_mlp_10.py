...
opt = pysmac.SMAC_optimizer( working_directory = './results/dataset10/smac_warm/' % os.environ, persistent_files=True, debug = False)

# Warmstart for Dataset #10 (optimum parameters from Dataset #1)
