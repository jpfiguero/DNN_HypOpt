...
with open('./results/dataset8/random_search/randomsearch.csv' % os.environ, 'w') as csvfile:
    fieldnames = ['parameters', 'score_mean', 'score_std']
    writer = csv.DictWriter(csvfile, fieldnames=fieldnames)
    writer.writeheader()

for score in grid_search1.grid_scores_:
    with open('./results/dataset8/random_search/randomsearch.csv' % os.environ, 'a') as csvfile:
