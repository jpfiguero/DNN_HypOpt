...
# Dataset 6 <- bad results, need to do feature selection first
...
opt = pysmac.SMAC_optimizer( working_directory = './results/dataset6/c_smac/' % os.environ, persistent_files=True, debug = False)
